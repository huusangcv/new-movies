const filter = {
  movies: [
    ...
    { id: 4, slug: 'phim-le', text: 'Phim Lẻ' },
    { id: 5, slug: 'tv-shows', text: 'TV Shows' },
    { id: 6, slug: 'hoat-hinh', text: 'Hoạt Hình' },
    { id: 7, slug: 'phim-vietsub', text: 'Phim Vietsub' },
    { id: 8, slug: 'phim-thuyet-minh', text: 'Phim Thuyết Minh' },
    { id: 9, slug: 'phim-long-tieng', text: 'Phim Lồng Tiếng' },
    { id: 10, slug: 'phim-bo-dang-chieu', text: 'Phim Bộ Đang Chiếu' },
    { id: 11, slug: 'phim-tron-bo', text: 'Phim Trọn Bộ' },
    { id: 12, slug: 'phim-sap-chieu', text: 'Phim Sắp Chiếu' },
    { id: 13, slug: 'subteam', text: 'Subteam' },
  ],
  types: [
